    ...
    public void onClick(View view){
            switch (view.getId()){
                case R.id.lang:
                    ...
                    break;
                case R.id.singUp:
                    new ThreadDB(handler, MainActivity.this).tUserAdd(login.getText().toString(), pass.getText().toString());
                    break;
                case R.id.singIn:
                    new ThreadDB(handler, MainActivity.this).tGetUser(login.getText().toString());
                    break;
                default:
                    break;
            }
